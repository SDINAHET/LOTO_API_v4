...
//         // On laisse JPA / @PrePersist gérer l'ID
//         // Si tu veux être sûr de ne pas utiliser un id envoyé par le client, tu peux décommenter :
//         // user.setId(null);
...
//         return userRepository.findById(id)
//                 .map(existing -> {
//                     // Copie tous les champs communs sauf ceux qu'on veut protéger
//                     // (adapter les noms si besoin : password, createdAt, updatedAt, etc.)
